...
public class ShowDetailActivity extends AppCompatActivity {
    ...
    private void getBundle(){
        ...
        int drawableReseourceId=this.getResources().getIdentifier(object.getPic(),"drawable",this.getPackageName());
        Glide.with(this)
                .load(drawableReseourceId)
                .into(picFood);
        ...
        totalPriceTxt.setText("Rp"+numberOrder * object.getFee());
    ...
    private void iniView(){
        ...
        picFood=findViewById(R.id.season8pic);
